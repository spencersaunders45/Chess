   ...
   class Board
   {
      ...
      */
      ...
      { 
         char[] tempBoard = _board.ToCharArray();
         int location;
         location = (_white.GetKing.GetRow() * 34) + (_white.GetKing.GetCol() * 4);
         tempBoard[location] = 'K';
         location = (_white.GetQueen.GetRow() * 34) + (_white.GetQueen.GetCol() * 4);
         tempBoard[location] = 'Q';
         location = (_white.GetRook1.GetRow() * 34) + (_white.GetRook1.GetCol() * 4);
         tempBoard[location] = 'R';
         location = (_white.GetRook2.GetRow() * 34) + (_white.GetRook2.GetCol() * 4);
         tempBoard[location] = 'R';
         location = (_white.GetBishop1.GetRow() * 34) + (_white.GetBishop1.GetCol() * 4);
         tempBoard[location] = 'B';
         location = (_white.GetBishop2.GetRow() * 34) + (_white.GetBishop2.GetCol() * 4);
         tempBoard[location] = 'B';
         location = (_white.GetKnight1.GetRow() * 34) + (_white.GetKnight1.GetCol() * 4);
         tempBoard[location] = 'N';
         location = (_white.GetKnight2.GetRow() * 34) + (_white.GetKnight2.GetCol() * 4);
         tempBoard[location] = 'N';
         location = (_white.GetPawn1.GetRow() * 34) + (_white.GetPawn1.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn2.GetRow() * 34) + (_white.GetPawn2.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn3.GetRow() * 34) + (_white.GetPawn3.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn4.GetRow() * 34) + (_white.GetPawn4.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn5.GetRow() * 34) + (_white.GetPawn5.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn6.GetRow() * 34) + (_white.GetPawn6.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn7.GetRow() * 34) + (_white.GetPawn7.GetCol() * 4);
         tempBoard[location] = 'P';
         location = (_white.GetPawn8.GetRow() * 34) + (_white.GetPawn8.GetCol() * 4);
         tempBoard[location] = 'P';
         _board = tempBoard.ToString();
      }
